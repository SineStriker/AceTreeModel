...
public:
    ...
    explicit AceTreeStandardEntity(Type type, AceTreeEntityExtra *extra, QObject *parent = nullptr);
...
public:
    ...
    explicit AceTreeEntityVector(AceTreeEntityExtra *extra, QObject *parent = nullptr);
    ~AceTreeEntityVector();
...
public:
    ...
    explicit AceTreeEntityRecordTable(AceTreeEntityExtra *extra, QObject *parent = nullptr);
...
public:
    ...
    explicit AceTreeEntityMapping(AceTreeEntityExtra *extra, QObject *parent = nullptr);
...
class ACETREE_EXPORT AceTreeEntityMappingExtra : public AceTreeEntityNotifyExtra {

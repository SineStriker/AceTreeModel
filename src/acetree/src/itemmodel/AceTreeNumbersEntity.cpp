...
public:
    AceTreeNumbersEntityPrivate(AceTreeEntityExtra *extra)
        : AceTreeEntityPrivate(extra), type_size(0), arr_to_bytes(nullptr), bytes_to_arr(nullptr) {
    }
...
void AceTreeNumbersEntityPrivate::deferred_init() {
    AceTreeEntityPrivate::deferred_init();
...
AceTreeNumbersEntity::AceTreeNumbersEntity(AceTreeEntityExtra *extra, QObject *parent)
    : AceTreeEntity(*new AceTreeNumbersEntityPrivate(extra), parent) {
}

...
public:
    AceTreeObjectEntityPrivate(AceTreeObjectEntity::Type type, AceTreeEntityExtra *extra)
...
AceTreeObjectEntity::AceTreeObjectEntity(AceTreeObjectEntity::Type type, QObject *parent)
    : AceTreeObjectEntity(type, nullptr, parent) {
}

AceTreeObjectEntity::AceTreeObjectEntity(AceTreeObjectEntity::Type type, AceTreeEntityExtra *extra,
                                         QObject *parent)
    : AceTreeEntity(*new AceTreeObjectEntityPrivate(type, extra), parent) {
}

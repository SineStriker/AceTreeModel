#ifndef ACETREESTANDARDENTITY_P_H
#define ACETREESTANDARDENTITY_P_H
...
public:
    ...
    public:
        PointerWrapper() : ref(nullptr){};

        template <class T1>
        PointerWrapper(T1 **ref) : ref(reinterpret_cast<T **>(ref)) {
    ...
    QHash<QString, PointerWrapper<AceTreeEntity>> childPostAssignRefs;
...
public:
    ...
    QHash<const QMetaObject *, QSet<QString>> nodeBuilderIndexes;
...
#endif // ACETREESTANDARDENTITY_P_H
